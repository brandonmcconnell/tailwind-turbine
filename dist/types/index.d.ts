...
export declare const resolveThemeExtend: <Theme extends NormalizedTheme>(theme: Theme, callback: (theme: Theme, isExtend: boolean) => unknown, preventExtendCreation?: boolean) => void;
export {};
